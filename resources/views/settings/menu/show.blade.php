                    ...
                    <table class="table table-hover text-nowrap" id="menu_table">
                        ...
                        <tbody>
                            @foreach ($menus as $menu)
                                ...
                                <tr align="center">
                                    <td style="width: 50px">
                                        <button class="btn btn-success add_sub_menu" title="Add Sub Menu" @if ($menu->parent_id > '0') disabled @endif> <i
                                                class="fas fa-plus"></i></button>
                                        <button class="btn btn-danger cancel" style="display: none;" title="Cancel">
