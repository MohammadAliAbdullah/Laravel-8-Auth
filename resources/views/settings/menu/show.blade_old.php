                        ...
                        <table class="table table-hover text-nowrap" id="menu_table">
                            ...
                            <tbody>
                                @foreach ($menus as $menu)
                                    <tr align="center">
                                        <td style="width: 50px">
                                            <button class="btn btn-success add_sub_menu" title="Add Sub Menu" 
                                            @if ($menu->parent_id > '0') disabled @endif
                                ...
                                <td>
                                    ...
                                    <input class="addInput id form-control input-sm" type="text" name="first_name" value="" id="addInput" hidden>
                                ...
                                <td>
                                    ...
                                    <input class="addInput name form-control input-sm" type="text" name="first_name"
                                ...
                                <td>
                                    ...
                                    <input class="addInput url form-control input-sm" type="text" name="first_name" value=""
                                        style="display: none;">
                                    <input class="editInput name form-control input-sm" type="text" name="first_name"
                                ...
                                <td align="center">
                                    <button class="btn btn-primary edit_menu" title="Edit Menu"><i
    ...
    <script>
        $(document).ready(function() {
            $('.add_sub_menu').on('click', function() {
                ...
                $(this).closest("tr").find(".save").click(function() {
                    alert('successfully!');
                });
